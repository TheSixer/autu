...
const Captcha = dynamic(() => import('react-captcha-code'), { ssr: false });
                      ...
                      <div className="form_group_grid-item">
                        ...
                        <div className="form_group" style={{ display: 'flex' }}>
                          ...
                          <input
                            ...
                            required
                          />
                          <Captcha className="form_code" charNum={4} onChange={handleClick} />
                        </div>
                      </div>
                      <div className="form_group_grid-item">
