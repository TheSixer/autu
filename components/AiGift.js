...
import AiTrader from "../assets/images/home/aitrader@2x.png";
        ...
        <div className="row">
          <div className="d-flex col-lg-6">
            <div className="cta-two__content wow fadeInUp">
              ...
              <h3 className="cta-two__content-title ai">AI赋能，降低普通交易员进入专业领域的门</h3>
              <div className="cta-two__text">
                <p>
                  简单便捷的内嵌自动化交易工具<br/>
                  针对高端客户提供CHATGPT接口辅助策略研发，协助无经验客户将交易策略转化为交易程序<br/>
